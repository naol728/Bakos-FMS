...
import { updateStatusLoanCommite } from "@/api/loan";
...
export default function ManageLoan() {
  ...
  const [committee_comment, setCommiteComment] = useState("");
  const [status, setStatus] = useState("");
  const queryclient = useQueryClient();
  const { mutate, isPending } = useMutation({
    mutationFn: updateStatusLoanCommite,
    onSuccess: (data) => {
  ...
  const handleUpdateStatus = (data) => {
    const { id } = data;
    mutate({ id, committee_comment, status });
  };
                      ...
                      <Dialog>
                        ...
                        <DialogContent className="max-w-md">
                          <DialogHeader>
                            ...
                            <DialogDescription>
                              Committee decision for this loan request
                            </DialogDescription>
                          </DialogHeader>
                          ...
                          <div className="space-y-4">
                            <Input
                              ...
                              value={committee_comment}
                              onChange={(e) =>
                                setCommiteComment(e.target.value)
                              }
                            />
